...
def OnBeginSpellCast( spell ):
	print "Cure Light Wounds OnBeginSpellCast"
...
def OnSpellEffect( spell ):
	...
	game.particles( 'sp-Cure Light Wounds', target )

	spell.target_list.remove_target( target )
	spell.spell_end( spell.id, 1)

def OnBeginRound( spell ):
	print "Cure Light Wounds OnBeginRound"
	print "spell.caster=", spell.caster, " caster.level= ", spell.caster_level
	#debug.breakp("Cure Light Wounds OnBeginRound")
	spell.spell_end( spell.id, 1)
