...
def cmrlv5():
	...
	item_create_in_inventory(PROTO_WONDROUS_GLOVES_OF_DEXTERITY_PLUS_2, npc)
	item_create_in_inventory(PROTO_WONDROUS_CLOAK_OF_CHARISMA_PLUS_4_STARS, npc)
	...
	obj_scripts_clear(npc)
	item_create_in_inventory(PROTO_ARMOR_MITHRAL_SHIRT_PLUS_1, npc)
	item_create_in_inventory(PROTO_WONDROUS_CLOAK_OF_RESISTANCE_PLUS_1_GREEN, npc)
	...
	item_create_in_inventory(PROTO_WONDROUS_GAUNTLETS_OF_OGRE_POWER, npc)
...
def c1():
	...
	if (1==1):
		...
		item_create_in_inventory(PROTO_CLOTH_BOOTS_SILVER_PLATE_BOOTS, npc)
...
def c4():
	...
	if (1==1):
		...
		item_create_in_inventory_buy(PROTO_CLOTH_BOOTS_SILVER_PLATE_BOOTS, npc)
