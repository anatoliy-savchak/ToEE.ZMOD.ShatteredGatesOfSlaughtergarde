...
#	monster_proto_id = 14370
	...
	npc = spell.caster
	if npc.name == 8036 or npc.name == 14425 or npc.name == 14212 or npc.name == 14211:		##  faction 7, 3,4,5,6 added -SA
	...
	for faction in spell.caster.factions:
		monster_obj.faction_add(faction)
