...
def AddToSequence(d20action, action_seq, tb_status):
	...
	print("Throw Ball of Fire:: AddToSequence")
	...
	if path_length > 60:
		print("Throw Ball of Fire:: AEC_ACTION_INVALID, path_length: {}".format(path_length))
...
def ProjectileHit(d20action, proj, obj2):
	...
	print("Throw Ball of Fire: Projectile Hit")
